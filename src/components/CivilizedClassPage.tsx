...
import { CivilizedClassFormModal } from "./CivilizedClassFormModal";
...
export function CivilizedClassPage({ onMenuOpen }: { onMenuOpen?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" style={{ color: "#111827" }}>
      ...
      {modalOpen && <CivilizedClassFormModal onClose={() => setModalOpen(false)} />}
      ...
      <div className="flex-1 overflow-y-auto bg-[#f5f5f7] p-4 md:p-6">
        <div className="glass rounded-[32px] overflow-hidden flex flex-col shadow-sm" style={{ minHeight: 500 }}>
          ...
          <DataTable columns={COLUMNS} rows={filtered} minWidth={900} />
