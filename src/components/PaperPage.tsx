...
import { Bell, ChevronDown, ChevronRight, Plus, Calendar, ClipboardList, X, CircleDot } from "lucide-react";
...
type PaperRow = { id: number };

export function PaperPage() {
  const [hasThesis, setHasThesis] = useState<"yes" | "no" | null>(null);
  const [rows, setRows] = useState<PaperRow[]>([{ id: 1 }]);
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5 text-sm" style={{ color: "#9ca3af" }}>
          ...
          <span style={{ color: "#374151", fontWeight: 500 }}>论文</span>
        </div>
              ...
              <>
                ...
                <div className="p-8 bg-white border-t border-gray-50">
                  ...
                  <div className="w-full border border-gray-100 rounded-xl overflow-hidden text-sm">
                    {/* Header */}
                    <div className="grid bg-gray-50 border-b border-gray-100" style={{ gridTemplateColumns: "48px 1fr 1.4fr 1fr 1fr 1fr" }}>
                    ...
                    {/* Rows */}
                    {rows.map((row, index) => (
                      <div key={row.id} className="grid border-b border-gray-100 last:border-0" style={{ gridTemplateColumns: "48px 1fr 1.4fr 1fr 1fr 1fr" }}>
