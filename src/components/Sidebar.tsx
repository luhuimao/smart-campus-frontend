                            ...
                            return (
                              <div key={childLabel}>
                                <div
                                  ...
                                  style={{ height: 30, padding: "0 10px", fontSize: 15, color: childActive ? "#2563eb" : "#374151", background: childActive ? "rgba(59,130,246,0.08)" : "transparent", fontWeight: childActive ? 600 : 400 }}
                                  ...
                                  onMouseLeave={(e) => { if (!childActive) { (e.currentTarget as HTMLDivElement).style.background = "transparent"; (e.currentTarget as HTMLDivElement).style.color = "#374151"; } }}
                                  onClick={() => {
                                    ...
                                    {grandChildren.map((gc) => {
                                      ...
                                      return (
                                        <div
                                          key={gc}
                                          className="flex items-center gap-2 rounded-xl cursor-pointer transition-all duration-150"
                                          style={{ height: 28, padding: "0 10px", fontSize: 14, color: gcActive ? "#2563eb" : "#374151", background: gcActive ? "rgba(59,130,246,0.08)" : "transparent", fontWeight: gcActive ? 600 : 400 }}
                                          ...
                                          onMouseLeave={(e) => { if (!gcActive) { (e.currentTarget as HTMLDivElement).style.background = "transparent"; (e.currentTarget as HTMLDivElement).style.color = "#374151"; } }}
