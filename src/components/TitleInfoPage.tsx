              ...
              <div className="p-8 bg-white border-t border-gray-50">
                ...
                >
                  ...
                  {[
                    ...
                    <div key={i} className="px-3 py-3 bg-gray-50 text-sm font-semibold text-gray-600 border-b border-r border-gray-100 last:border-r-0 flex items-center">
                  ...
                  <div className="px-2 py-2 bg-white border-b border-r border-gray-100">
                    <select className="w-full bg-white border border-gray-200 rounded-lg px-2 py-1 text-sm outline-none appearance-none transition-all"
                      onFocus={(e) => Object.assign(e.currentTarget.style, focusStyle)}
                      onBlur={(e)  => Object.assign(e.currentTarget.style, blurStyle)}>
                      <option value=""></option>
                      <option>正高级教师</option>
