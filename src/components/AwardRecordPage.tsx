...
import { Bell, ChevronDown, ChevronRight, Plus, Image, Calendar, ClipboardList, X } from "lucide-react";
...
export function AwardRecordPage() {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5 text-sm" style={{ color: "#9ca3af" }}>
          ...
          <span style={{ color: "#374151", fontWeight: 500 }}>获奖记录</span>
        </div>
